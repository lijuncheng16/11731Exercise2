...
if __name__ == "__main__":
    ...
    output_file = "/home/billyli/Documents/11731Exercise2/alignment-nltk-model1.txt"

    bitext = read_bitext(source_file, target_file)
    ibm1 = IBMModel1(bitext, 10)
    print('translation score buch-book: {0:.3f}'.format(ibm1.translation_table['buch']['book']))
